    ...
    <Screen scroll={true}>
      ...
      <View style={styles.content}>
        <View style={styles.glassCard}>
          <AppText variant="pageTitle">E-postanı doğrula</AppText>
          <AppText muted>Gönderdiğimiz bağlantıya tıklayarak hesabını doğrula.</AppText>
        </View>
        ...
        >
          <AppText style={styles.primaryBtnText}>Girişe dön</AppText>
        </Pressable>
      </View>
    </Screen>
  );
