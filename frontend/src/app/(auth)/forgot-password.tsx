  ...
  return (
    <Screen scroll={true}>
      ...
      <View style={styles.content}>
        <AppText variant="pageTitle">Şifreni yenile</AppText>
        <AppText muted>E-posta adresini gir; yenileme bağlantısını gönderelim.</AppText>
        ...
        >
          <AppText style={styles.primaryBtnText}>Bağlantı gönder</AppText>
        </Pressable>
      </View>
    </Screen>
  );
